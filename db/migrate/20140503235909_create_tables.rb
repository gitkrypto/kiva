class CreateTables < ActiveRecord::Migration
  def change
    ...
    create_table :accounts do |t|
      ...
      t.integer     :balance_nqt,         :integer, limit: 8, unsigned: true, null: false
      t.string      :public_key
    end
    ...
    create_table :blocks do |t|
      ...
      t.integer     :total_amount_nqt,    :integer, limit: 8, unsigned: true, null: false
      t.integer     :total_fee_nqt,       :integer, limit: 8, unsigned: true, null: false
      t.integer     :total_pos_nqt,       :integer, limit: 8, unsigned: true, null: false
      t.integer     :version
    ...
    create_table :transactions do |t|
      ...
      t.integer     :amount_nqt,          :integer, limit: 8, unsigned: true, null: false
      t.integer     :fee_nqt,             :integer, limit: 8, unsigned: true, null: false
    end      
  end
end
